...
public OnPluginStart()
{
	...
	g_modifyw = CreateConVar("sm_modify_weapon", "weapon_deagle", "which weapon do you want to modify damage https://github.com/oqyh/modify_weapon_damage/tree/main/example-weapons-id");
	g_damage = CreateConVar( "sm_modify_damage", "300", "Damage sm_modify_weapon Deal  || 0= No Damage || 1= Lowest Damage || 300= 1 Hit");
